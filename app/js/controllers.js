...
ireadControllers.controller("BookDetailCtrl", ['$scope', '$http', '$location', '$document', '$timeout', 'storage', '$q', 'fonts', function BookDetailCtrl($scope, $http, $location, $document, $timeout, storage, $q, fonts) {
  $scope.catalog = [];
